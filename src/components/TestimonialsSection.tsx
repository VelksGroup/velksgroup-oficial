...
export const TestimonialsSection: React.FC<TestimonialsSectionProps> = ({ t, currentLang }) => {
  ...
  return (
    <section ref={containerRef} className="py-32 px-4 relative overflow-hidden bg-[#050505]">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative w-full max-w-4xl mx-auto min-h-[450px] md:min-h-[350px]">
        ...
        <div className="flex items-center justify-between max-w-4xl mx-auto mt-16 px-2">
